        ...
        <div class="comment-show-con clearfix">
            ...
            <div class="comment-show-con-list pull-left clearfix">
                <div class="pl-text clearfix">
                    ...
                    <span class="my-pl-con">&nbsp;来啊 造作ewwd啊!</span>
                </div>
                <div class="date-dz">
...
<script type="text/javascript" src="jQueryWbPl/js/jquery-1.12.0.min.js"></script>
...
<script type="text/javascript">
    $('.comment-show').on('click','.hf-pl',function(){
        ...
        var flag =false;
        if(/*oHfVal.replace(/^ +| +$/g,'') == '' || oHfVal == oAllVal*/ flag){

        }else {
            $.getJSON("jQueryWbPl/json/pl.json",function(data){
                var oAt = '';
                var oHf = '';
