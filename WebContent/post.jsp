...
<%
	...
	List<Comment> comments = postDao.getAllComment(pid);
                ...
                <div class="row bg-white has-shadow">
                  <div class="left-col col-lg-6 d-flex align-items-center justify-content-between">
                    <div class="project-title d-flex align-items-center">
                      ...
                      <div class="text">
                        <h3 class="h4">${post.getTitle()}</h3><small>${post.getContent()}</small>
                      </div>
                    </div>
                  ...
                  <div class="right-col col-lg-6 d-flex align-items-center">
                    ...
                    <div class="project-progress">
                      <div class="progress">
                        <div role="progressbar" style="width: ${proportion}%; height: 6px;" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100" class="progress-bar bg-red"></div>
                      </div>
                    </div>
                  </div>
                </div>
                      ...
                      <div class="item clearfix">
                        <div class="feed d-flex justify-content-between">
                          <div class="feed-body d-flex justify-content-between"><a href="#" class="feed-profile"><img src="img/avatar-3.jpg" alt="person" class="img-fluid rounded-circle"></a>
                            <div class="content">
                              <h5>${comment.getUserName()}</h5><span>Posted a new comment </span>
                              <!-- <div class="full-date"><small>Today 5:60 pm - 12.06.2014</small></div> -->
                              
                            </div>
                            
                          </div>
                          <div class="date text-right"><small>${comment.getTime()}</small></div>
                          
                        </div>
                        <div class="quote has-shadow"> <small>${comment.getContent()}</small></div>
                        <div class="CTAs pull-right"><a href='javascript:;' class="btn btn-xs btn-secondary"><i class="fa fa-thumbs-up"> </i>${comment.getLike()}</a><a href="" class="btn btn-xs btn-secondary"><i class="fa fa-thumbs-down"> </i>${comment.getLike()}</a></div>                      
                     </div>      
                  			...
                  			<div class = "content">  
                  			 <c:choose>
                  			  	<c:when test="${cookie.isLogin.value==\"true\"}">
                  			     	<form class="form-validate" method ="post" action ="Reply">             		
	                  		     		<div class="form-group row">                         
                          					<div class="col-md-12">
                            					<textarea placeholder="说点什么吧"  required data-msg="你总不能啥也不填丫" name ="content" class="form-control"></textarea>
                          					</div>
                                 		</div>  	                  		     
		                  		     	<div class="form-group row">
	                          				<div class="col-sm-4 offset-sm-0">	     
	                            				...
	                            				<input type="submit" class="btn btn-primary" value ="马上评论" ></input>
	                          				</div>
	                       	        	</div>
                  			    	</form>        		
	                  			</c:when>	                  			
