  ...
  <body>
    <div class="page login-page">
          ...
          <div class="row">
            ...
            <div class="col-lg-6 bg-white">
              <div class="form d-flex align-items-center">
                <div class="content">
                  <form method="post" class="form-validate" action = "UserLogin">
                    ...
                    <input id="register" type="submit" name="registerSubmit" class="btn btn-primary" value="登录"></input>
      ...
      <div class="copyrights text-center">
        <p>Design by <a href="#" class="external">SCU yanay</a>
